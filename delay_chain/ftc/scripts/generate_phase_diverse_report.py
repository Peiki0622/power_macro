...
def main() -> int:
    ...
    lines = ["# FTC Phase-Diverse Sampling Result", "", "## A. Motivation From The NO-GO Result", "", "The completed single-snapshot study measured acute voltage/phase angles of 5.04 deg (1.10 V), 15.42 deg (0.90 V), and 26.57 deg (0.75 V); its 15.42 deg median was below the 30 deg screening gate. The global C/W projection remains closed.", "", "## B. Phase-Diversity Hypothesis", "", "This study did not attempt another algebraic phase-rejection transform. It held the shared RVT/LVT/XOR physical front-end fixed and tested whether deliberately separated capture phases have complementary physical transient apertures.", "", "## C. Candidate Phase Qualification", "", "Nine phases from 245.126260 ps to 354.873740 ps were physically measured. All nine were valid at 1.10/0.90/0.75 V and all eight coarse points; five evenly distributed phases were used for bounded transient screening.", ""]
