...
// testbench procedural replay loop because the installed VCS front end crashes
// while finalizing hierarchical real-valued task calls.  Keeping the model
// contract separate from the replay driver makes the limitation explicit and
// prevents this artifact from being mistaken for a synthesizable level shifter.
//
