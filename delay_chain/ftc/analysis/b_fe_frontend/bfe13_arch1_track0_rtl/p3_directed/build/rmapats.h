...
extern "C" {
#endif
void  rmaPropagate0_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate0_t0_p3_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate1_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate1_t0_p3_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate2_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate2_t0_p3_simv_daidir (UB  * pcode, UB  val);
void  rmaPropagate3_p3_simv_daidir (UB  * pcode, vec32  * I1130, U  I1001);
void  rmaPropagate4_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate5_p_p3_simv_daidir (UB  * pcode, vec32  * I1130, U  I1001);
void  rmaPropagate5_p3_simv_daidir (UB  * pcode, vec32  * I1130, U  I1001);
void  rmaPropagate5_lbs_p3_simv_daidir (UB  * pcode, scalar  val, U  I1160);
void  rmaPropagate5_lps_p3_simv_daidir (UB  * pcode, vec32  * I1547, U  I1160, U  I1557);
void  rmaPropagate5_s0f_p3_simv_daidir (UB  * pcode, vec32  * I1130);
void  rmaPropagate6_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate7_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate8_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate9_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate10_p3_simv_daidir (UB  * pcode, vec32  * I1130, U  I1001);
void  rmaPropagate11_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate12_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate13_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_p3_simv_daidir (UB  * pcode, scalar  val);
void  rmaPropagate14_t0_p3_simv_daidir (UB  * pcode, UB  val);
