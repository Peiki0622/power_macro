...
- Primary source: `/home/zhupl25/chiplet_side_channel/chiplet_gds_data/power_macro/delay_chain/ftc/runs/static_fine/static_transfer.csv` (36-point fine evidence; 36 VDD points).
- Repeat-phase consistency source: `/home/zhupl25/chiplet_side_channel/chiplet_gds_data/power_macro/delay_chain/ftc/runs/phase_diverse_screen/phase_candidate_coarse.csv`.
...
| --- | --- | --- | --- | --- | --- | --- |
| 29 | LVT | strict_increasing | 864.420 | 168.614 | 33.051 | stable lead; strict_increasing; 0 plateau(s); positive 50 mV margin |
...
- Its median |dW/dVDD| is 71.432 ps/100 mV over the high-end five steps and 611.152 ps/100 mV over the low-end five steps; low-end sensitivity is higher in this evidence.
